...
stock pp_GetTittle(Handle:pp, String:displayStr[], size)
{
...
stock bool:pp_GetMenuItem(Handle:pp, itemIndex, String:id[], idsize, &drawFlags=ITEMDRAW_DEFAULT, String:displayStr[]="", displaySize)
{
